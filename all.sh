...
echo "convert gene..."
perl scripts/tsv2ttl_gene.pl   $PGARDEN_IN/mysql/import_gene/import_data/*_gene.import.tsv > $PGARDEN_RDF/rdf/pg_gene.ttl
echo "convert marker..."
perl scripts/tsv2ttl_marker.pl $PGARDEN_IN/mysql/import_marker/*.import_marker.tsv > $PGARDEN_RDF/rdf/pg_marker.ttl
echo "convert trait..."
perl scripts/tsv2ttl_trait.pl $PGARDEN_IN/mysql/import_trait/import_trait_related_*.txt > $PGARDEN_RDF/rdf/pg_trait.ttl
echo "wget pubtator..."
